...
export default defineConfig(({ command }) => ({
  // Déployé dans un sous-dossier sur OVH (https://www.cours-vandewalle.fr/clicetmots/),
  ...
  base: command === 'build' ? '/clicetmots/' : '/',
  plugins: [react(), tailwindcss()],
  // Le backend est en PHP : impossible à faire tourner dans le serveur de dev
  // Vite. On proxie donc /clicetmots/api vers le vrai serveur OVH — le dev tape
